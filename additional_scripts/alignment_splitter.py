...
def split_mag_from_aln(input_fasta, taxon_name, gene_name=None):
    ...
    if gene_name == None:
        ...
        SeqIO.write(mag_records, gene_name + "_q.aln", "fasta")
        SeqIO.write(nonmag_records, gene_name + "_ref.aln", "fasta")
...
if __name__ == "__main__":
    ...
    split_mag_from_aln(args.alignment, args.taxon, args.gene)
